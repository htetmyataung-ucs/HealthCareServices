          ...
          <div class="tile">
          	<div>
          		<div style="float:left">
          			<h3>Medical Shop List</h3>
          		</div>
          		<div style="float: right; margin-top:0px; margin-bottom: 15px;">
              		<button class="btn btn-primary">
               			 <a href="${pageContext.request.contextPath}/admin/medicalshop" style="text-decoration: none; color: aliceblue;">Create New Shop</a>
              		</button>
            	</div>
            </div>
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <c:forEach items="${medicalShopList}" var="m" varStatus="r">
						<tr>
						<td>${r.count }</td>
						<td>${m.name }</td>
						<td>${m.phone }</td>
						...
						<td>
							...
							<button class="btn btn-primary">
								<a href="${pageContext.request.contextPath}/admin/deleteShop/${m.id}" style="text-decoration:none; color:white;">Delete</a>
							</button>
							</td>
						</tr>
					</c:forEach>                  
