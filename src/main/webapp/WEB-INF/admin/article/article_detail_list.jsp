          ...
          <div class="tile">
          	<div>
          		<div style="float:left">
          			<h3>ArticleDetail List</h3>
          		</div>
          		<div style="float: right; margin-top:0px; margin-bottom: 15px;">
              		<button class="btn btn-primary">
               			 <a href="${pageContext.request.contextPath}/admin/create_article_detail" style="text-decoration: none; color: aliceblue;">Create ArticleDetail</a>
              		</button>
            	</div>
            </div>
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <c:forEach items="${articleDetailList}" var="ad" varStatus="r">
						<tr>
						<td>${r.count }</td>
						<td>${ad.name }</td>
						<td>${ad.gender }</td>
						...
						<td>
							...
							<button class="btn btn-primary">
								<a href="${pageContext.request.contextPath}/admin/delete_articleDetail/${ad.id}" style="text-decoration:none; color:white;">Delete</a>
							</button>
							</td>
						</tr>
					</c:forEach>                  
