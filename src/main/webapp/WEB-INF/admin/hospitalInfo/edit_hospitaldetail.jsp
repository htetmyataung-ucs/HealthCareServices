...
<body>
	...
	<form:form
		action="${pageContext.request.contextPath}/admin/edit_hospitalDetail"
		method="POST" enctype="multipart/form-data"
		modelAttribute="hospitalDetail">
		<div class="container">
			...
			<div class="form-group">
				...
				<form:input type="text" class="form-control"
					placeholder="Enter Phone" path="address"></form:input>
			</div>

			<div class="form-group">
				<form:label path="email">Email:</form:label>
				<form:input type="text" class="form-control"
					placeholder="Enter Email" path="email"></form:input>
			</div>

			<div class="form-group">
				<form:label path="time">Time:</form:label>
				<form:input type="text" class="form-control"
					placeholder="Enter Time" path="time"></form:input>
			</div>

			<div class="form-group">
				<form:label path="date">Date:</form:label>
				<form:input type="text" class="form-control"
					placeholder="Enter Date" path="date"></form:input>
			</div>

			<div class="form-group">
				<form:label path="file">File:</form:label>
				<form:input path="file" type="file" class="form-control"
					placeholder="Choose File:"></form:input>
			</div>
			...
			<div class="form-group">
				...
				<form:input type="text" class="form-control"
					placeholder="Enter longitude" path="longitude"></form:input>
			</div>

			<div class="form-group">
				<form:label path="description">Description:</form:label>
				<textarea id="editor" name="description" class="form-control">${hospitalDetail.description}</textarea>
			</div>
