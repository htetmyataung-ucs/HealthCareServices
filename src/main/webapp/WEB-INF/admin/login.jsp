    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" action="/login" method="post">
          <h3 class="login-head" style="margin-top:-30px;"><i class="fa fa-lg fa-fw fa-user"></i>SIGN IN</h3>
          ...
          <div class="form-group btn-container">
            ...
            <a href="${pageContext.request.contextPath}/registerTest" style="">Create New Account!</a>
          </div>
        </form>
