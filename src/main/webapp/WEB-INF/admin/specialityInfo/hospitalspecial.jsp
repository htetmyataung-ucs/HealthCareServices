...
<body>
  ...
  <form:form action="${pageContext.request.contextPath}/admin/create_hospitalspecial" method="POST" modelAttribute="hospitalspecial">
   <div class="container">
   <h2>Insert Hospital_Special</h2>
    ...
    <form:label path="specialityId">Choose Speciality:</form:label>
     ...
     <!--<form:input type="text" class="form-control" placeholder="Enter True/False" path="status"></form:input>-->
