<footer>
	<div class="footer-wrappr section-bg3"
		data-background="<c:url value='/resources/assets/img/gallery/footer-bg.png'/>"
		style="height: 0px;">
						...
						<div class="single-footer-caption">
							...
							<div class="footer-tittle">
								<div class="footer-pera">
									<p>Praesent porttitor, nulla vitae posuere iaculis, arcu
										nisl dignissim dolor, a pretium misem ut ipsum.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="footer-border">
					<div class="row">
						<div class="col-xl-10 " style="display: inline;">
							...
							<!-- <div style="float:right;"><p>Hello</p></div> -->
						</div>
					</div>
				</div>
			</div>
