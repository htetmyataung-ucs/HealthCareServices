...
<html class="no-js" lang="zxx">
    <head>
    	...
    	<link rel="stylesheet" href="<c:url value='/resources/assets/css/gijgo.css'/>">
    	<link rel="stylesheet" href="<c:url value='/resources/assets/css/animate.min.css'/>">
    	<link rel="stylesheet" href="<c:url value='/resources/assets/css/animated-headline.css'/>">
    ...
    <body>
		...
		<script src="<c:url value='/resources/assets/js/jquery.countdown.min.js'/>"></script>
		<script src="<c:url value='/resources/assets/js/hover-direction-snake.min.js'/>"></script>
