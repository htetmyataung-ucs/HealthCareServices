						...
						<div class="col-xl-7 col-lg-8 col-md-10 ">
							<div class="hero-wrapper">
								<div class="hero__caption">
									<h1 data-animation="fadeInUp" data-delay=".3s" style="">Disease</h1>
		...
		<div class="container">
			<div class="itemCard">
				<c:forEach items="${diseaseList}" var="dis">
					<div class="card">
						<img class="card-img-top" src="/images/${dis.photo }"
							alt="Card image">
						<div class="card-body">
							<a
								href="${pageContext.request.contextPath}/articleDetailInfo/${dis.id}"><h2>${dis.name}</h2></a>
						</div>
					</div>
				</c:forEach>
			</div>
