...
@media screen and (max-width:1200px) and (min-width:700px) {
	...
	.card {
		...
		height: 200px;
		border-radius: 18% 0 18% 0;
		border: 3px solid rgb(0, 153, 0, 0.6);
		margin-left: 40px;
		margin-bottom: 35px;
		box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0
			rgba(0, 0, 0, 0.19);
						...
						<div class="col-xl-7 col-lg-8 col-md-10 ">
							<div class="hero-wrapper">
								<div class="hero__caption">
									<h1 data-animation="fadeInUp" data-delay=".3s" style="">FirstAid</h1>
		...
		<div class="container">
			<div class="itemCard">
				<c:forEach items="${firstAidList}" var="fa">
					<div class="card">
						<img class="card-img-top" src="/images/${fa.photo }"
							alt="Card image">
						<div class="card-body">
							<a
								href="${pageContext.request.contextPath}/articleDetailInfo/${fa.id}"><h2>${fa.name}</h2></a>
						</div>
					</div>
				</c:forEach>
			</div>
