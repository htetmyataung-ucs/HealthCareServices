...
public class ArticleDetailConverter {
	 ...
	 * ArticleDetail ad = new ArticleDetail(); if(adDTO.getId()!=null) {
	 * ad.setId(adDTO.getId()); } ad.setName(adDTO.getName());
	 * ad.setDescription(adDTO.getDescription()); ad.setGender(adDTO.getGender());
	 * ad.getArticle().setId(adDTO.getArticleId()); return ad; }
	 */
